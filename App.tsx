      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
        <div className="bg-slate-900 border border-slate-700 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div className="p-6 border-b border-slate-800 flex justify-between items-center bg-slate-950">
             ...
             <button onClick={() => setShowSyncModal(false)} className="text-slate-500 hover:text-white"><Swords className="w-5 h-5 rotate-45" /></button>
          </div>
          ...
          <div className="p-6 border-t border-slate-800 bg-slate-950 flex justify-end gap-3">
            {syncStep !== 'FETCHING' && (
               <button onClick={() => setShowSyncModal(false)} className="px-4 py-2 text-slate-400 hover:text-white">Cancel</button>
            )}
